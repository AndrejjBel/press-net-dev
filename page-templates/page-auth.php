...
<main id="primary" class="site-main auth-page container">
        ...
        <div class="login-register-page__content">
            ...
            <div class="warning-text">
                <?php if ($_REQUEST) { ?>
                    <?php if ($_REQUEST['login'] == 'failed') { ?>
                        <span class="warning-login mb14">You have entered an incorrect username or password</span>
                    <?php } elseif ($_REQUEST['user_identified'] == 'failed') { ?>
                        <span class="warning-login mb14">E-mail needs to be confirmed</span>
                    <?php } ?>
                <?php } ?>
            </div>
            ...
            <form name="loginform" id="loginform" action="/wp-login.php" method="post" class=" mb28">
                ...
                <div class="input-group input-with-icon mb24">
                    <input type="password" class="input" name="pwd" id="user_pass" placeholder="Password" required autocomplete="new-password"/>
                ...
                <div class="checkbox mb14">
                    <label for="rememberme" class="checkbox__label">
                        ...
                        <span class="checkbox__label__text">Remember me</span>
                    </label>
                    <input type="checkbox" name="rememberme" id="rememberme" class="checkbox__input" value="forever"/>
                </div>

                <button class="button btn-primary auth-submit mb28" type="submit" form="loginform" name="wp-submit" id="wp-submit" disabled>Login</button>
