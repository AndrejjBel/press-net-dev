    ...
    <form id="add-post-form">
        <div class="field-group-two mb24">
            <div class="field-group">
                ...
                <div class="input-group">
                    <input type="text" class="input" name="post_title" id="post_title" placeholder="Company name" required value="<?php the_title(); ?>" />
                </div>
        ...
        <div class="field-group-two mb24">
            <div class="field-group">
                ...
                <div class="input-group">
                    <input type="text" class="input" name="website" id="website" placeholder="Website" value="<?php echo $post->website; ?>" />
                </div>
                <!-- <span class="field-group__warning-input">Field is required</span> -->
            </div>
            <div class="field-group">
                ...
                <div class="input-group">
                    <input type="text" class="input suggest" name="city" id="city" placeholder="City" value="<?php echo $post->city; ?>" />
