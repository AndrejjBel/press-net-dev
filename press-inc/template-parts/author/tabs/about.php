    ...
    <form class="about-fields">
        ...
        <div class="field-group mb24">
            ...
            <div class="input-group user-description">
                <textarea type="textarea" rows="10" class="textarea" name="description" id="description" placeholder="About me"><?php echo press_net_get_authordata('description'); ?></textarea>
            </div>
        </div>
