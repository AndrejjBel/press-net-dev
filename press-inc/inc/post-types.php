...
// Post type My portfolio
add_action( 'init', 'press_net_register_post_type_portfolio' );
function press_net_register_post_type_portfolio(){
    $tax_name = 'Portfolio categories';
    $tax_singular_name = 'Portfolio category';
    $tax_slug = PORTFOLIO_CAT;

    $post_type_name = 'Portfolio';
    $post_type_singular_name = 'Portfolio';
