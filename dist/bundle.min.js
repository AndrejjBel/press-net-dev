...
var headTitleName = function headTitleName() {
  ...
  if (archiveAuthor) {
    ...
    var postTitle = document.querySelectorAll('form#add-post-form input#post_title');
    var jobTitle = document.querySelectorAll('form#add-post-form input#job_title');
...
var fieldSelectProcessingOneselect = function fieldSelectProcessingOneselect() {
  var fieldSelectAll = document.querySelectorAll('form .field-select.one');
...
var fieldSelectProcessingMultiselect = function fieldSelectProcessingMultiselect() {
  var fieldSelectAll = document.querySelectorAll('form .field-select.multi');
  if (fieldSelectAll.length > 0) {
    fieldSelectAll.forEach(function (item) {
      ...
      document.addEventListener('click', function (e) {
        var sBtn = e.composedPath().includes(item.children[0]);
        var sOptions = e.composedPath().includes(item.children[1]);
        if (!sBtn && !sOptions) {
          item.children[1].classList.remove('active');
          if (item.children[1].classList.contains('active')) {
            item.children[0].children[1].children[0].style.transform = 'rotate(180deg)';
      ...
      var _iterator2 = _createForOfIteratorHelper(item.children[1].children),
        _step2;
      try {
    ...
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      ...
      if (node.className == 'option-tag') {
        if (node.children[0].checked == true) {
          ...
          result.insertAdjacentHTML("beforeend", "<span class=\"option-result\" id=\"".concat(node.children[0].id, "\">").concat(node.children[0].name).concat(icon, "</span>"));
        }
      }
      ;
    }
...
function renderTags(options, result) {
  ...
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      ...
      if (node.className == 'option-tag') {
        if (node.children[0].checked == true) {
          result.insertAdjacentHTML("beforeend", "<span id=\"".concat(node.children[0].id, "\">").concat(node.children[0].name).concat(icon, "</span>"));
        }
        ;
      }
      ;
...
var tagsClose = function tagsClose() {
  var resultsWrap = document.querySelectorAll('.results-wrap__results');
  if (resultsWrap.length > 0) {
    resultsWrap.forEach(function (item) {
        ...
        var _loop3 = function _loop3() {
          ...
          if (el.className == 'option-result') {
            ...
            el.children[0].addEventListener('click', function () {
              ...
              var tagIds = [];
              var _iterator6 = _createForOfIteratorHelper(item.parentElement.nextElementSibling.children),
                _step6;
              try {
                for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
        ...
        node.children[0].addEventListener('click', function () {
          ...
          try {
            for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
              ...
              if (_node.className == 'option-tag') {
                if (_node.children[0].checked == true) {
                  tagIds.push(_node.children[0].value);
                }
                ;
              }
              ;
